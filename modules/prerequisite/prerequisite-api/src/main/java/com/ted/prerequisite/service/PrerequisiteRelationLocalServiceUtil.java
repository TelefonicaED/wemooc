 ...
 * {@link com.ted.prerequisite.service.impl.PrerequisiteRelationLocalServiceImpl} and is the
 ...
 * @see com.ted.prerequisite.service.base.PrerequisiteRelationLocalServiceBaseImpl
...
public class PrerequisiteRelationLocalServiceUtil {
	...
	*/
	public static com.ted.prerequisite.model.PrerequisiteRelation addPrerequisiteRelation(
		com.ted.prerequisite.model.PrerequisiteRelation prerequisiteRelation) {
	...
	*/
	public static com.ted.prerequisite.model.PrerequisiteRelation createPrerequisiteRelation(
	...
	*/
	public static com.ted.prerequisite.model.PrerequisiteRelation deletePrerequisiteRelation(
		long prerequisiteRelationId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static com.ted.prerequisite.model.PrerequisiteRelation fetchPrerequisiteRelation(
		long prerequisiteRelationId) {
	...
	*/
	...
	public static java.util.List<com.ted.prerequisite.model.PrerequisiteRelation> getPrerequisiteRelation(
		long classNamePrerequisiteId, long classNameId, long classPK) {
		return getService()
	...
	*/
	...
	public static java.util.List<com.ted.prerequisite.model.PrerequisiteRelation> getPrerequisiteRelations(
		...
		return getService()
				   .getPrerequisiteRelations(classNameId, classPK, start, end);
	}
	...
	*/
	...
	public static int getPrerequisiteRelationsCount(long classNameId,
		long classPK) {
		return getService().getPrerequisiteRelationsCount(classNameId, classPK);
	}

	public static java.util.List<com.ted.prerequisite.model.Prerequisite> getPrerequisites(
		long classNameId, long classPK) {
	...
	*/
	public static com.ted.prerequisite.model.PrerequisiteRelation updatePrerequisiteRelation(
		com.ted.prerequisite.model.PrerequisiteRelation prerequisiteRelation) {
	...
	private static ServiceTracker<PrerequisiteRelationLocalService, PrerequisiteRelationLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(PrerequisiteRelationLocalService.class);

		ServiceTracker<PrerequisiteRelationLocalService, PrerequisiteRelationLocalService> serviceTracker =
			new ServiceTracker<PrerequisiteRelationLocalService, PrerequisiteRelationLocalService>(bundle.getBundleContext(),
