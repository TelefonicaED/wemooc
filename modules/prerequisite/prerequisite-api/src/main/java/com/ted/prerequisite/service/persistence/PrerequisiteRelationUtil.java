...
/**
 * The persistence utility for the prerequisite relation service. This utility wraps <code>com.ted.prerequisite.service.persistence.impl.PrerequisiteRelationPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PrerequisiteRelationUtil {
	 ...
	 */
	public static Map<Serializable, PrerequisiteRelation> fetchByPrimaryKeys(
	 ...
	 */
	public static List<PrerequisiteRelation> findByUuid(
	 ...
	 */
	public static PrerequisiteRelation findByUuid_First(
			String uuid,
			OrderByComparator<PrerequisiteRelation> orderByComparator)
		throws com.ted.prerequisite.exception.
			NoSuchPrerequisiteRelationException {
	 ...
	 */
	public static PrerequisiteRelation fetchByUuid_First(
		String uuid,
		OrderByComparator<PrerequisiteRelation> orderByComparator) {
	 ...
	 * @throws NoSuchPrerequisiteRelationException if a matching prerequisite relation could not be found
	 */
	public static PrerequisiteRelation findByUuid_Last(
			String uuid,
			OrderByComparator<PrerequisiteRelation> orderByComparator)
		throws com.ted.prerequisite.exception.
			NoSuchPrerequisiteRelationException {
	 ...
	 */
	public static PrerequisiteRelation fetchByUuid_Last(
		String uuid,
		OrderByComparator<PrerequisiteRelation> orderByComparator) {
	...
	public static PrerequisiteRelation[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			prerequisiteRelationId, uuid, orderByComparator);
	}
	...
	public static List<PrerequisiteRelation> findByClassNameIdClassPK(
		...
		return getPersistence().findByClassNameIdClassPK(
	...
	public static PrerequisiteRelation findByClassNameIdClassPK_First(
		...
		return getPersistence().findByClassNameIdClassPK_First(
	...
	public static PrerequisiteRelation fetchByClassNameIdClassPK_First(
		...
		return getPersistence().fetchByClassNameIdClassPK_First(
			classNameId, classPK, orderByComparator);
	}
	...
	public static PrerequisiteRelation findByClassNameIdClassPK_Last(
		...
		return getPersistence().findByClassNameIdClassPK_Last(
			classNameId, classPK, orderByComparator);
	}
	...
	public static PrerequisiteRelation fetchByClassNameIdClassPK_Last(
		...
		return getPersistence().fetchByClassNameIdClassPK_Last(
			classNameId, classPK, orderByComparator);
	}
	...
	public static PrerequisiteRelation[] findByClassNameIdClassPK_PrevAndNext(
		...
		return getPersistence().findByClassNameIdClassPK_PrevAndNext(
			prerequisiteRelationId, classNameId, classPK, orderByComparator);
	}
	 ...
	 * @param classPK the class pk
	 */
	public static void removeByClassNameIdClassPK(
		long classNameId, long classPK) {
	 ...
	 * @return the number of matching prerequisite relations
	 */
	public static int countByClassNameIdClassPK(
		long classNameId, long classPK) {
	 ...
	 * @return the matching prerequisite relations
	 */
	public static List<PrerequisiteRelation>
		findByClassNamePrerequisiteIdClassNameIdClassPK(
			long classNamePrerequisiteId, long classNameId, long classPK) {

		return getPersistence().findByClassNamePrerequisiteIdClassNameIdClassPK(
	 ...
	 * @throws NoSuchPrerequisiteRelationException if a matching prerequisite relation could not be found
	 */
	public static PrerequisiteRelation
	...
	public static PrerequisiteRelation[]
		...
		return getPersistence().
			findByClassNamePrerequisiteIdClassNameIdClassPK_PrevAndNext(
				prerequisiteRelationId, classNamePrerequisiteId, classNameId,
	...
	public static void removeByClassNamePrerequisiteIdClassNameIdClassPK(
		...
		getPersistence().removeByClassNamePrerequisiteIdClassNameIdClassPK(
			classNamePrerequisiteId, classNameId, classPK);
	}
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			PrerequisiteRelationPersistence.class);

		ServiceTracker
			<PrerequisiteRelationPersistence, PrerequisiteRelationPersistence>
				serviceTracker =
					new ServiceTracker
						<PrerequisiteRelationPersistence,
						 PrerequisiteRelationPersistence>(
