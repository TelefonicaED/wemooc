 ...
 */
@ProviderType
public interface PrerequisiteRelationPersistence extends BasePersistence<PrerequisiteRelation> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<PrerequisiteRelation> findByUuid(String uuid,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<PrerequisiteRelation> orderByComparator);
	...
	* @return the matching prerequisite relations
	*/
	public java.util.List<PrerequisiteRelation> findByClassNamePrerequisiteIdClassNameIdClassPK(
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, PrerequisiteRelation> fetchByPrimaryKeys(
