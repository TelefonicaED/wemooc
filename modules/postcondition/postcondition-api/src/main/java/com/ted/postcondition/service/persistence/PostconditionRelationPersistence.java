 ...
 */
@ProviderType
public interface PostconditionRelationPersistence extends BasePersistence<PostconditionRelation> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<PostconditionRelation> findByUuid(String uuid,
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<PostconditionRelation> orderByComparator);
	...
	* @return the matching postcondition relations
	*/
	public java.util.List<PostconditionRelation> findByClassNamePostconditionIdClassNameIdClassPK(
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, PostconditionRelation> fetchByPrimaryKeys(
