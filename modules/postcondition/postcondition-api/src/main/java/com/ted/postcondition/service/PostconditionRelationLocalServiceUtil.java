 ...
 * {@link com.ted.postcondition.service.impl.PostconditionRelationLocalServiceImpl} and is the
...
public class PostconditionRelationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.ted.postcondition.service.impl.PostconditionRelationLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static com.ted.postcondition.model.PostconditionRelation addPostconditionRelation(
		long classNamePostconditionId, long classNameId, long classPK,
		String extraData) {
		return getService()
				   .addPostconditionRelation(classNamePostconditionId,
	...
	*/
	public static com.ted.postcondition.model.PostconditionRelation createPostconditionRelation(
		long postconditionRelationId) {
		return getService().createPostconditionRelation(postconditionRelationId);
	}
	...
	*/
	public static com.ted.postcondition.model.PostconditionRelation deletePostconditionRelation(
		long postconditionRelationId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deletePostconditionRelation(postconditionRelationId);
	}
	...
	*/
	...
	public static com.ted.postcondition.model.PostconditionRelation fetchPostconditionRelation(
		long postconditionRelationId) {
	...
	* @throws PortalException if a postcondition relation with the primary key could not be found
	*/
	public static com.ted.postcondition.model.PostconditionRelation getPostconditionRelation(
		long postconditionRelationId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getPostconditionRelation(postconditionRelationId);
	}

	public static java.util.List<com.ted.postcondition.model.PostconditionRelation> getPostconditionRelation(
		long classNamePostconditionId, long classNameId, long classPK) {
		return getService()
				   .getPostconditionRelation(classNamePostconditionId,
			classNameId, classPK);
	}
	...
	*/
	public static java.util.List<com.ted.postcondition.model.PostconditionRelation> getPostconditionRelations(
		int start, int end) {
	...
	public static java.util.List<com.ted.postcondition.model.PostconditionRelation> getPostconditionRelations(
		...
		return getService()
				   .getPostconditionRelations(classNameId, classPK, start, end);
	}
	...
	*/
	...
	public static int getPostconditionRelationsCount(long classNameId,
		long classPK) {
		return getService().getPostconditionRelationsCount(classNameId, classPK);
	}

	public static java.util.List<com.ted.postcondition.model.Postcondition> getPostconditions(
		long classNameId, long classPK) {
	...
	*/
	public static com.ted.postcondition.model.PostconditionRelation updatePostconditionRelation(
		com.ted.postcondition.model.PostconditionRelation postconditionRelation) {
	...
	private static ServiceTracker<PostconditionRelationLocalService, PostconditionRelationLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(PostconditionRelationLocalService.class);

		ServiceTracker<PostconditionRelationLocalService, PostconditionRelationLocalService> serviceTracker =
			new ServiceTracker<PostconditionRelationLocalService, PostconditionRelationLocalService>(bundle.getBundleContext(),
