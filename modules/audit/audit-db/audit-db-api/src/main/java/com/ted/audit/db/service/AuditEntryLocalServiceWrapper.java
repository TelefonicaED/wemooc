...
public class AuditEntryLocalServiceWrapper implements AuditEntryLocalService,
	...
	*/
	...
	public void addAuditEntry(long companyId, long groupId, int actionId,
		...
		_auditEntryLocalService.addAuditEntry(companyId, groupId, actionId,
			className, classPK, associationClassPK, userId, userName, extraData);
	}
	...
	public void addAuditEntry(long companyId, long groupId, int actionId,
		...
		String extraData) {
		_auditEntryLocalService.addAuditEntry(companyId, groupId, actionId,
			className, classPK, userId, userName, extraData);
	}
