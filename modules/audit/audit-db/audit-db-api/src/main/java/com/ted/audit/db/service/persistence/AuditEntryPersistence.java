...
public interface AuditEntryPersistence extends BasePersistence<AuditEntry> {
	 ...
	 * @return the range of matching audit entries
	 */
	public java.util.List<AuditEntry> findByCompanyId(
	 ...
	 * @return the matching audit entries
	 */
	public java.util.List<AuditEntry> findByCompanyIdActionId(
	 ...
	 * @return the range of matching audit entries
	 */
	public java.util.List<AuditEntry> findByUserId(
	 ...
	 * @return the range of matching audit entries
	 */
	public java.util.List<AuditEntry> findByClassNameId(
