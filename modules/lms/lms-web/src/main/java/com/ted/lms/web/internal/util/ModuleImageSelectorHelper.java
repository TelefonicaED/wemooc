...
public class ModuleImageSelectorHelper {
	
	public ModuleImageSelectorHelper(long oldSmallImageId, long imageFileEntryId) {
		...
		private static final Log log = LogFactoryUtil.getLog(ModuleImageSelectorHelper.class);
