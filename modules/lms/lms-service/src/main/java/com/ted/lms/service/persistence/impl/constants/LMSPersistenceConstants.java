...
package com.ted.lms.service.persistence.impl.constants;
...
public class LMSPersistenceConstants {
	...
	public static final String BUNDLE_SYMBOLIC_NAME = "com.ted.lms.service";
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(LMSPersistenceConstants.class);
