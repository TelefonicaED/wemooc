...
/**
 * The persistence utility for the schedule service. This utility wraps {@link com.ted.lms.inscription.teams.service.persistence.impl.SchedulePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ScheduleUtil {
	...
	* @return the matching schedule, or <code>null</code> if a matching schedule could not be found
	*/
	public static Schedule fetchByTeamId(long teamId, boolean retrieveFromCache) {
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, Schedule> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<SchedulePersistence, SchedulePersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SchedulePersistence.class);

		ServiceTracker<SchedulePersistence, SchedulePersistence> serviceTracker = new ServiceTracker<SchedulePersistence, SchedulePersistence>(bundle.getBundleContext(),
				SchedulePersistence.class, null);
