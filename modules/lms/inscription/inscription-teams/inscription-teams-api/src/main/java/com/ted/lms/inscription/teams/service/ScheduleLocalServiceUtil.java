 ...
 * <code>com.ted.lms.inscription.teams.service.impl.ScheduleLocalServiceImpl</code> and
...
public class ScheduleLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ted.lms.inscription.teams.service.impl.ScheduleLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static com.ted.lms.inscription.teams.model.Schedule addSchedule(
		...
		return getService().addSchedule(
			userId, teamId, startDate, endDate, courseId);
	}
	...
	public static com.ted.lms.inscription.teams.model.Schedule
		getScheduleByTeamId(long teamId) {
	 ...
	 */
	public static java.util.List<com.ted.lms.inscription.teams.model.Schedule>
		getSchedules(int start, int end) {
	...
	public static void updateScheduleUserDates(
		long userId, com.ted.lms.inscription.teams.model.Schedule schedule,
		long courseId, long studentId) {

		getService().updateScheduleUserDates(
			userId, schedule, courseId, studentId);
	}
	...
	private static ServiceTracker<ScheduleLocalService, ScheduleLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ScheduleLocalService.class);

		ServiceTracker<ScheduleLocalService, ScheduleLocalService>
			serviceTracker =
				new ServiceTracker<ScheduleLocalService, ScheduleLocalService>(
					bundle.getBundleContext(), ScheduleLocalService.class,
					null);
