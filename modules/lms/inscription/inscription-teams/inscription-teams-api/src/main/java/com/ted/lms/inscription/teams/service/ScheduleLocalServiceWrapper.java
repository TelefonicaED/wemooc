...
public class ScheduleLocalServiceWrapper
	...
	public com.ted.lms.inscription.teams.model.Schedule addSchedule(
		...
		return _scheduleLocalService.addSchedule(
	...
	public void deleteScheduleUserDates(
		...
		_scheduleLocalService.deleteScheduleUserDates(
			schedule, courseId, userId);
	}
	 ...
	 */
	@Override
	public java.util.List<com.ted.lms.inscription.teams.model.Schedule>
	...
	public void updateScheduleUserDates(
		...
		_scheduleLocalService.updateScheduleUserDates(
	...
	public void updateScheduleUsersDates(
		...
		_scheduleLocalService.updateScheduleUsersDates(
			userId, schedule, courseId);
	}
