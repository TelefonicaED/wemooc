 ...
 * <code>com.ted.lms.service.impl.LearningActivityResultLocalServiceImpl</code> and
...
public class LearningActivityResultLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ted.lms.service.impl.LearningActivityResultLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static long countStudentFinished(
		...
		return getService().countStudentFinished(
	...
	public static com.ted.lms.model.LearningActivityResult
		fetchLearningActivityResult(long larId) {
	...
	public static com.ted.lms.model.LearningActivityResult
		...
		return getService().fetchLearningActivityResultByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static com.ted.lms.model.LearningActivityResult
			getLearningActivityResult(long larId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static com.ted.lms.model.LearningActivityResult
		getLearningActivityResult(long actId, long userId) {
	...
	public static com.ted.lms.model.LearningActivityResult
		...
		return getService().getLearningActivityResultByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static java.util.List<com.ted.lms.model.LearningActivityResult>
	...
	public static java.util.List<com.ted.lms.model.LearningActivityResult>
		...
		return getService().getLearningActivityResultsByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static int getRequiredLearningActivityResultsByModuleCount(
		...
		return getService().getRequiredLearningActivityResultsByModuleCount(
			moduleId, userId);
	}
	...
	public static com.ted.lms.model.LearningActivityResult
		...
		return getService().updateLearningActivityResult(
			learningActivityResult);
	}
	...
	static {
		...
		ServiceTracker
			<LearningActivityResultLocalService,
			 LearningActivityResultLocalService> serviceTracker =
				new ServiceTracker
					<LearningActivityResultLocalService,
					 LearningActivityResultLocalService>(
