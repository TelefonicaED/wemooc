 ...
 * <code>com.ted.lms.service.impl.CourseTypeRelationLocalServiceImpl</code> and
...
public class CourseTypeRelationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ted.lms.service.impl.CourseTypeRelationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static void addCourseTypeRelation(
	...
	public static java.util.List<Long> getCalificationTypeIds(
		long courseTypeId) {

		return getService().getCalificationTypeIds(courseTypeId);
	}

	public static java.util.List<com.ted.lms.model.CalificationTypeFactory>
	...
	public static java.util.List<com.ted.lms.model.CourseEvalFactory>
		getCourseEvals(long courseTypeId) {
	 ...
	 */
	public static java.util.List<com.ted.lms.model.CourseTypeRelation>
	...
	public static java.util.List<Long> getInscriptionTypeIds(
		long courseTypeId) {

		return getService().getInscriptionTypeIds(courseTypeId);
	}

	public static java.util.List<com.ted.lms.model.InscriptionTypeFactory>
	...
	public static java.util.List<com.ted.lms.model.LearningActivityTypeFactory>
	...
	public static java.util.List
		<com.liferay.portal.kernel.model.LayoutSetPrototype> getTemplates(
			long courseTypeId) {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CourseTypeRelationLocalService.class);
