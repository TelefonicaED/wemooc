 ...
 */
@ProviderType
public class CourseResultLocalServiceWrapper
	implements CourseResultLocalService,
	...
	public com.ted.lms.model.CourseResult addCourseResult(
		...
		return _courseResultLocalService.addCourseResult(
	...
	public long dynamicQueryCount(
		...
		return _courseResultLocalService.dynamicQueryCount(
	...
	@Override
	public com.ted.lms.model.CourseResult fetchCourseResult(
	...
	@Override
	public com.ted.lms.model.CourseResult getCourseResult(
			long courseId, long userId)
	...
	public java.util.List<com.ted.lms.model.CourseResult> getMyCourses(
		...
		return _courseResultLocalService.getMyCourses(
	...
	public int getMyCoursesCount(
		...
		return _courseResultLocalService.getMyCoursesCount(
