...
public class CourseServiceWrapper
	...
	public int countCourses(
		...
		return _courseService.countCourses(
	...
	public long executeCopyCourse(
		...
		return _courseService.executeCopyCourse(
	...
	@Override
	public com.ted.lms.model.Course moveEntryToTrash(long courseId)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _courseService.moveEntryToTrash(courseId);
	}

	@Override
	public void restoreEntryFromTrash(long courseId)
		throws com.liferay.portal.kernel.exception.PortalException {

		_courseService.restoreEntryFromTrash(courseId);
	}
	...
	public java.util.List<com.ted.lms.model.Course> searchCourses(
		...
		return _courseService.searchCourses(
			companyId, title, description, language, status, parentCourseId,
	...
	public void unsetUserCourse(
		...
		_courseService.unsetUserCourse(
	...
	public void updateSmallImage(
		...
		_courseService.updateSmallImage(
