...
public interface LearningActivity
	extends LearningActivityModel, PersistedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to <code>com.ted.lms.model.impl.LearningActivityImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<LearningActivity, Long> ACT_ID_ACCESSOR =
		new Accessor<LearningActivity, Long>() {
