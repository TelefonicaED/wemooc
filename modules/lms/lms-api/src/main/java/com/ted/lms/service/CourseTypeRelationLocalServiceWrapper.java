...
public class CourseTypeRelationLocalServiceWrapper
	...
	public com.ted.lms.model.CourseTypeRelation addCourseTypeRelation(
		...
		return _courseTypeRelationLocalService.addCourseTypeRelation(
			courseTypeRelation);
	}
	...
	public void addCourseTypeRelation(
		...
		_courseTypeRelationLocalService.addCourseTypeRelation(
			courseTypeId, classNameId, classPKs);
	}
	...
	public com.ted.lms.model.CourseTypeRelation createCourseTypeRelation(
		com.ted.lms.service.persistence.CourseTypeRelationPK
			courseTypeRelationPK) {

		return _courseTypeRelationLocalService.createCourseTypeRelation(
			courseTypeRelationPK);
	}
	...
	public com.ted.lms.model.CourseTypeRelation deleteCourseTypeRelation(
		...
		return _courseTypeRelationLocalService.deleteCourseTypeRelation(
			courseTypeRelation);
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _courseTypeRelationLocalService.deletePersistedModel(
			persistedModel);
	}
	...
	public long dynamicQueryCount(
		...
		return _courseTypeRelationLocalService.dynamicQueryCount(
	...
	public com.ted.lms.model.CourseTypeRelation fetchCourseTypeRelation(
		...
		return _courseTypeRelationLocalService.fetchCourseTypeRelation(
			courseTypeRelationPK);
	}
	...
	public java.util.List<Long> getCalificationTypeIds(long courseTypeId) {
		return _courseTypeRelationLocalService.getCalificationTypeIds(
			courseTypeId);
	}

	@Override
	public java.util.List<com.ted.lms.model.CalificationTypeFactory>
		getCalificationTypes(long courseTypeId) {

		return _courseTypeRelationLocalService.getCalificationTypes(
			courseTypeId);
	}
	...
	public com.ted.lms.model.CourseTypeRelation getCourseTypeRelation(
		...
		return _courseTypeRelationLocalService.getCourseTypeRelation(
			courseTypeRelationPK);
	}
	 ...
	 */
	@Override
	public java.util.List<com.ted.lms.model.CourseTypeRelation>
		getCourseTypeRelations(int start, int end) {

		return _courseTypeRelationLocalService.getCourseTypeRelations(
			start, end);
	}
	...
	public java.util.List<Long> getInscriptionTypeIds(long courseTypeId) {
		return _courseTypeRelationLocalService.getInscriptionTypeIds(
			courseTypeId);
	}

	@Override
	public java.util.List<com.ted.lms.model.InscriptionTypeFactory>
		getInscriptionTypes(long courseTypeId) {

		return _courseTypeRelationLocalService.getInscriptionTypes(
			courseTypeId);
	}

	@Override
	public java.util.List<Long> getLearningActivityTypeIds(long courseTypeId) {
		return _courseTypeRelationLocalService.getLearningActivityTypeIds(
			courseTypeId);
	}

	@Override
	public java.util.List<com.ted.lms.model.LearningActivityTypeFactory>
		getLearningActivityTypes(long courseTypeId) {

		return _courseTypeRelationLocalService.getLearningActivityTypes(
			courseTypeId);
	}
	...
	public java.util.List<com.liferay.portal.kernel.model.LayoutSetPrototype>
		getTemplates(long courseTypeId) {
	...
	public com.ted.lms.model.CourseTypeRelation updateCourseTypeRelation(
		...
		return _courseTypeRelationLocalService.updateCourseTypeRelation(
			courseTypeRelation);
	}
