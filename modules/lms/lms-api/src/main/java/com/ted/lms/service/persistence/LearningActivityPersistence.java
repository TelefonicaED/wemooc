...
public interface LearningActivityPersistence extends BasePersistence<LearningActivity> {
	...
	* @return the matching learning activities
	*/
	public java.util.List<LearningActivity> findByModuleIdNotTypeId(
	...
	* @return the matching learning activities
	*/
	public java.util.List<LearningActivity> findByGroupIdModuleId(
	...
	* @return the matching learning activities that the user has permission to view
	*/
	public java.util.List<LearningActivity> filterFindByGroupIdModuleId(
		long groupId, long moduleId);
