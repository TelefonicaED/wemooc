...
/**
 * The persistence utility for the course type service. This utility wraps <code>com.ted.lms.service.persistence.impl.CourseTypePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CourseTypeUtil {
	 ...
	 */
	public static Map<Serializable, CourseType> fetchByPrimaryKeys(
	 ...
	 */
	public static CourseType update(
		CourseType courseType, ServiceContext serviceContext) {
	 ...
	 */
	public static List<CourseType> findByCompanyId(
	 ...
	 */
	public static CourseType findByCompanyId_First(
	 ...
	 */
	public static CourseType fetchByCompanyId_First(
		long companyId, OrderByComparator<CourseType> orderByComparator) {
	 ...
	 * @throws NoSuchCourseTypeException if a matching course type could not be found
	 */
	public static CourseType findByCompanyId_Last(
			long companyId, OrderByComparator<CourseType> orderByComparator)
		throws com.ted.lms.exception.NoSuchCourseTypeException {
	 ...
	 */
	public static CourseType fetchByCompanyId_Last(
		long companyId, OrderByComparator<CourseType> orderByComparator) {
	 ...
	 */
	public static CourseType[] findByCompanyId_PrevAndNext(
			long courseTypeId, long companyId,
			OrderByComparator<CourseType> orderByComparator)
		throws com.ted.lms.exception.NoSuchCourseTypeException {

		return getPersistence().findByCompanyId_PrevAndNext(
			courseTypeId, companyId, orderByComparator);
	}
	 ...
	 * @return the matching course type, or <code>null</code> if a matching course type could not be found
	 */
	public static CourseType fetchByCourseTypeId(
		long courseTypeId, boolean useFinderCache) {

		return getPersistence().fetchByCourseTypeId(
			courseTypeId, useFinderCache);
	}
	...
	private static ServiceTracker<CourseTypePersistence, CourseTypePersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CourseTypePersistence.class);

		ServiceTracker<CourseTypePersistence, CourseTypePersistence>
			serviceTracker =
				new ServiceTracker
					<CourseTypePersistence, CourseTypePersistence>(
						bundle.getBundleContext(), CourseTypePersistence.class,
						null);
