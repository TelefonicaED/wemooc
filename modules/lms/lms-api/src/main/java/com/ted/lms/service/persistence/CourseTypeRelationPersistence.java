 ...
 */
@ProviderType
public interface CourseTypeRelationPersistence extends BasePersistence<CourseTypeRelation> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public java.util.List<CourseTypeRelation> findByCourseTypeIdClassNameId(
		long courseTypeId, long classNameId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<CourseTypeRelation> orderByComparator);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, CourseTypeRelation> fetchByPrimaryKeys(
