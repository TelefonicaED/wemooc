 ...
 */
@ProviderType
public interface LearningActivityResultPersistence
	extends BasePersistence<LearningActivityResult> {
	 ...
	 */
	public java.util.List<LearningActivityResult> findByUuid(
	 ...
	 * @return the matching learning activity results
	 */
	public java.util.List<LearningActivityResult> findByUuid_C(
	 ...
	 * @return the range of matching learning activity results
	 */
	public java.util.List<LearningActivityResult> findByActId(
