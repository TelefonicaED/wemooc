 ...
 * {@link com.ted.lms.service.impl.CourseTypeLocalServiceImpl} and is the
 ...
 * @see com.ted.lms.service.base.CourseTypeLocalServiceBaseImpl
...
public class CourseTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.ted.lms.service.impl.CourseTypeLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static com.ted.lms.model.CourseType addCourseType(
		...
		return getService()
				   .addCourseType(nameMap, descriptionMap, iconSelector,
			serviceContext);
	}

	public static long addOriginalIconFileEntry(long userId, long groupId,
		long entryId,
		com.liferay.portal.kernel.servlet.taglib.ui.ImageSelector imageSelector)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .addOriginalIconFileEntry(userId, groupId, entryId,
			imageSelector);
	}
	...
	*/
	...
	public static com.ted.lms.model.CourseType updateCourseType(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateCourseType(courseTypeId, nameMap, descriptionMap,
	...
	static {
		...
		ServiceTracker<CourseTypeLocalService, CourseTypeLocalService> serviceTracker =
			new ServiceTracker<CourseTypeLocalService, CourseTypeLocalService>(bundle.getBundleContext(),
				CourseTypeLocalService.class, null);
