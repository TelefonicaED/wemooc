...
public interface LearningActivityTryPersistence extends BasePersistence<LearningActivityTry> {
	...
	* @return the matching learning activity tries
	*/
	public java.util.List<LearningActivityTry> findByUuid_C(String uuid,
		long companyId);
	...
	* @return the matching learning activity tries
	*/
	public java.util.List<LearningActivityTry> findByActIdUserId(long actId,
		long userId);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, LearningActivityTry> fetchByPrimaryKeys(
