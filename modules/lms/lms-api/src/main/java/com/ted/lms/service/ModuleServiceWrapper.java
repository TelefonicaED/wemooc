 ...
 */
@ProviderType
public class ModuleServiceWrapper
	implements ModuleService, ServiceWrapper<ModuleService> {
	...
	public com.ted.lms.model.Module addModule(
		...
		return _moduleService.addModule(
	...
	public com.ted.lms.model.Module updateModule(
		...
		return _moduleService.updateModule(
