...
public interface CourseResultPersistence extends BasePersistence<CourseResult> {
	 ...
	 */
	public java.util.List<CourseResult> findByCourseId(
	...
	public java.util.List<CourseResult> findByCourseId(
		long courseId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<CourseResult>
			orderByComparator);
	 ...
	 * @return the matching course results
	 */
	public java.util.List<CourseResult> findByUserId(long userId);
	 ...
	 * @return the range of matching course results
	 */
	public java.util.List<CourseResult> findByUserId(
	 ...
	 * @return the matching course results
	 */
	public java.util.List<CourseResult> findByCourseIdPassed(
	 ...
	 * @return the matching course results
	 */
	public java.util.List<CourseResult> findByFinished(
		long courseId, boolean passed);
