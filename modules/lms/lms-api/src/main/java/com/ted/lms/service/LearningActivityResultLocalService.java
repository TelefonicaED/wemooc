...
/**
 * Provides the local service interface for LearningActivityResult. Methods of this
...
public interface LearningActivityResultLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LearningActivityResultLocalServiceUtil} to access the learning activity result local service. Add custom service methods to <code>com.ted.lms.service.impl.LearningActivityResultLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LearningActivityResult getLearningActivityResult(
