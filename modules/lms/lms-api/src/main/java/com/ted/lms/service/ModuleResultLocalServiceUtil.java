 ...
 * {@link com.ted.lms.service.impl.ModuleResultLocalServiceImpl} and is the
...
public class ModuleResultLocalServiceUtil {
	...
	*/
	...
	private static ServiceTracker<ModuleResultLocalService, ModuleResultLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(ModuleResultLocalService.class);

		ServiceTracker<ModuleResultLocalService, ModuleResultLocalService> serviceTracker =
			new ServiceTracker<ModuleResultLocalService, ModuleResultLocalService>(bundle.getBundleContext(),
