 ...
 * <code>com.ted.lms.service.impl.StudentLocalServiceImpl</code> and
...
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ted.lms.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static boolean canEnroll(
		...
		return getService().canEnroll(
			course, userId, locale, permissionChecker);
	}

	public static boolean canUnsubscribe(
			com.ted.lms.model.Course course, long userId,
			com.liferay.portal.kernel.security.permission.PermissionChecker
				permissionChecker)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static int countStudentsFinished(
		long courseId, long companyId, String keywords, int status,
		java.util.LinkedHashMap<String, Object> params, int start, int end) {

		return getService().countStudentsFinished(
	...
	public static int countStudentsFromCourse(
		long courseId, long companyId, String keywords, int status,
		java.util.LinkedHashMap<String, Object> params) {

		return getService().countStudentsFromCourse(
	...
	public static com.ted.lms.model.CourseResult enrollStudent(
		...
		return getService().enrollStudent(
	 ...
	 */
	public static boolean unsubscribeStudent(
			com.ted.lms.model.Course course, long userId,
			com.liferay.portal.kernel.security.permission.PermissionChecker
				permissionChecker)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().unsubscribeStudent(
