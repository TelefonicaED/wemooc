...
public interface CourseLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CourseLocalServiceUtil} to access the course local service. Add custom service methods to <code>com.ted.lms.service.impl.CourseLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Course> getChildsRegistredUser(
	...
	public JSONObject importCourseMembers(
			long userId, long courseId, long roleId, FileEntry fileEntry)
		throws IOException, PortalException;

	public JSONObject importEditions(
			long userId, long courseId, FileEntry fileEntry)
		throws IOException, PortalException;
	...
	public List<Course> searchCourses(
		long companyId, String freeText, String language, int[] status,
		long parentCourseId, long groupId, LinkedHashMap<String, Object> params,
	...
	@Indexable(type = IndexableType.REINDEX)
	public Course updateCourse(
			long userId, long courseId, Date registrationStartDate,
	...
	public void updateSmallImage(
			long courseId, ImageSelector smallImageSelector,
			ServiceContext serviceContext)
		throws PortalException;
