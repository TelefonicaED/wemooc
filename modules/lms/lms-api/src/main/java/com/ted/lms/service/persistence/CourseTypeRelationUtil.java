...
/**
 * The persistence utility for the course type relation service. This utility wraps <code>com.ted.lms.service.persistence.impl.CourseTypeRelationPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CourseTypeRelationUtil {
	 ...
	 */
	public static Map<Serializable, CourseTypeRelation> fetchByPrimaryKeys(
	...
	public static List<CourseTypeRelation> findByCourseTypeIdClassNameId(
		...
		return getPersistence().findByCourseTypeIdClassNameId(
	...
	public static List<CourseTypeRelation> findByCourseTypeIdClassNameId(
		...
		return getPersistence().findByCourseTypeIdClassNameId(
			courseTypeId, classNameId, start, end);
	}
	...
	public static CourseTypeRelation findByCourseTypeIdClassNameId_First(
		...
		return getPersistence().findByCourseTypeIdClassNameId_First(
	...
	public static CourseTypeRelation fetchByCourseTypeIdClassNameId_First(
		...
		return getPersistence().fetchByCourseTypeIdClassNameId_First(
			courseTypeId, classNameId, orderByComparator);
	}
	...
	public static CourseTypeRelation findByCourseTypeIdClassNameId_Last(
		...
		return getPersistence().findByCourseTypeIdClassNameId_Last(
			courseTypeId, classNameId, orderByComparator);
	}
	...
	public static CourseTypeRelation fetchByCourseTypeIdClassNameId_Last(
		...
		return getPersistence().fetchByCourseTypeIdClassNameId_Last(
			courseTypeId, classNameId, orderByComparator);
	}
	 ...
	 */
	public static CourseTypeRelation[]
			findByCourseTypeIdClassNameId_PrevAndNext(
				CourseTypeRelationPK courseTypeRelationPK, long courseTypeId,
				long classNameId,
				OrderByComparator<CourseTypeRelation> orderByComparator)
		throws com.ted.lms.exception.NoSuchCourseTypeRelationException {

		return getPersistence().findByCourseTypeIdClassNameId_PrevAndNext(
			courseTypeRelationPK, courseTypeId, classNameId, orderByComparator);
	}
	 ...
	 * @param classNameId the class name ID
	 */
	public static void removeByCourseTypeIdClassNameId(
		long courseTypeId, long classNameId) {

		getPersistence().removeByCourseTypeIdClassNameId(
			courseTypeId, classNameId);
	}
	 ...
	 */
	public static int countByCourseTypeIdClassNameId(
		long courseTypeId, long classNameId) {

		return getPersistence().countByCourseTypeIdClassNameId(
			courseTypeId, classNameId);
	}
	...
	public static void cacheResult(
		List<CourseTypeRelation> courseTypeRelations) {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CourseTypeRelationPersistence.class);

		ServiceTracker
			<CourseTypeRelationPersistence, CourseTypeRelationPersistence>
				serviceTracker =
					new ServiceTracker
						<CourseTypeRelationPersistence,
						 CourseTypeRelationPersistence>(
