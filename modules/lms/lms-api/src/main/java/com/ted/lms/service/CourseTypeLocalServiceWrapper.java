 ...
 */
@ProviderType
public class CourseTypeLocalServiceWrapper
	implements CourseTypeLocalService, ServiceWrapper<CourseTypeLocalService> {
	...
	public com.ted.lms.model.CourseType addCourseType(
		...
		return _courseTypeLocalService.addCourseType(
	...
	public long addOriginalIconFileEntry(
		...
		return _courseTypeLocalService.addOriginalIconFileEntry(
	...
	public long dynamicQueryCount(
		...
		return _courseTypeLocalService.dynamicQueryCount(
	...
	public com.ted.lms.model.CourseType updateCourseType(
		...
		return _courseTypeLocalService.updateCourseType(
