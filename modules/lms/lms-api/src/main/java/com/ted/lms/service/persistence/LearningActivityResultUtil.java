...
public class LearningActivityResultUtil {
	 ...
	 * @return the matching learning activity results
	 */
	public static List<LearningActivityResult> findByActIdPassedEndDateNotNull(
		long actId, boolean passed) {

		return getPersistence().findByActIdPassedEndDateNotNull(actId, passed);
	}
	...
	public static List<LearningActivityResult> findByActIdPassedEndDateNotNull(
		...
		return getPersistence().findByActIdPassedEndDateNotNull(
			actId, passed, start, end);
	}
	...
	public static List<LearningActivityResult> findByActIdPassedEndDateNotNull(
		...
		return getPersistence().findByActIdPassedEndDateNotNull(
			actId, passed, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchLearningActivityResultException if a matching learning activity result could not be found
	 */
	public static LearningActivityResult findByActIdPassedEndDateNotNull_First(
			long actId, boolean passed,
			OrderByComparator<LearningActivityResult> orderByComparator)
		throws com.ted.lms.exception.NoSuchLearningActivityResultException {

		return getPersistence().findByActIdPassedEndDateNotNull_First(
	 ...
	 * @return the first matching learning activity result, or <code>null</code> if a matching learning activity result could not be found
	 */
	public static LearningActivityResult fetchByActIdPassedEndDateNotNull_First(
		long actId, boolean passed,
		OrderByComparator<LearningActivityResult> orderByComparator) {

		return getPersistence().fetchByActIdPassedEndDateNotNull_First(
			actId, passed, orderByComparator);
	}
	 ...
	 * @throws NoSuchLearningActivityResultException if a matching learning activity result could not be found
	 */
	public static LearningActivityResult findByActIdPassedEndDateNotNull_Last(
			long actId, boolean passed,
			OrderByComparator<LearningActivityResult> orderByComparator)
		throws com.ted.lms.exception.NoSuchLearningActivityResultException {

		return getPersistence().findByActIdPassedEndDateNotNull_Last(
			actId, passed, orderByComparator);
	}
	 ...
	 * @return the last matching learning activity result, or <code>null</code> if a matching learning activity result could not be found
	 */
	public static LearningActivityResult fetchByActIdPassedEndDateNotNull_Last(
		long actId, boolean passed,
		OrderByComparator<LearningActivityResult> orderByComparator) {

		return getPersistence().fetchByActIdPassedEndDateNotNull_Last(
			actId, passed, orderByComparator);
	}
	 ...
	 * @throws NoSuchLearningActivityResultException if a learning activity result with the primary key could not be found
	 */
	public static LearningActivityResult[]
			findByActIdPassedEndDateNotNull_PrevAndNext(
				long larId, long actId, boolean passed,
				OrderByComparator<LearningActivityResult> orderByComparator)
		throws com.ted.lms.exception.NoSuchLearningActivityResultException {

		return getPersistence().findByActIdPassedEndDateNotNull_PrevAndNext(
			larId, actId, passed, orderByComparator);
	}
	 ...
	 * @param passed the passed
	 */
	public static void removeByActIdPassedEndDateNotNull(
		long actId, boolean passed) {

		getPersistence().removeByActIdPassedEndDateNotNull(actId, passed);
	}
	 ...
	 * @return the number of matching learning activity results
	 */
	public static int countByActIdPassedEndDateNotNull(
		long actId, boolean passed) {

		return getPersistence().countByActIdPassedEndDateNotNull(actId, passed);
	}
