 ...
 */
@ProviderType
public class ModuleResultLocalServiceWrapper
	implements ModuleResultLocalService,
	...
	public com.ted.lms.model.ModuleResult addModuleResult(
		...
		return _moduleResultLocalService.addModuleResult(
			moduleId, userId, serviceContext);
	}
	...
	public int countModulesUserPassed(long groupId, long userId) {
		return _moduleResultLocalService.countModulesUserPassed(
			groupId, userId);
	}
	...
	public long dynamicQueryCount(
		...
		return _moduleResultLocalService.dynamicQueryCount(
	...
	@Override
	public com.ted.lms.model.ModuleResult getModuleResult(
		long moduleId, long userId) {
	...
	public com.ted.lms.model.ModuleResult updateModuleResult(
		...
		return _moduleResultLocalService.updateModuleResult(
