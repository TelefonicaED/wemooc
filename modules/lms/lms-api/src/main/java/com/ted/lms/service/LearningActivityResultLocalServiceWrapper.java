...
public class LearningActivityResultLocalServiceWrapper
	...
	public LearningActivityResultLocalServiceWrapper(
		...
		_learningActivityResultLocalService =
	...
	public com.ted.lms.model.LearningActivityResult addLearningActivityResult(
		...
		return _learningActivityResultLocalService.addLearningActivityResult(
	...
	public long countStudentFinished(
		...
		return _learningActivityResultLocalService.countStudentFinished(
			actId, companyId, courseGroupId);
	}
	...
	public com.ted.lms.model.LearningActivityResult
		createLearningActivityResult(long larId) {

		return _learningActivityResultLocalService.createLearningActivityResult(
			larId);
	}
	...
	@Override
	public com.ted.lms.model.LearningActivityResult
			deleteLearningActivityResult(long larId)
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _learningActivityResultLocalService.deletePersistedModel(
			persistedModel);
	}
	...
	public long dynamicQueryCount(
		...
		return _learningActivityResultLocalService.dynamicQueryCount(
			dynamicQuery);
	}
	...
	public com.ted.lms.model.LearningActivityResult fetchLearningActivityResult(
		...
		return _learningActivityResultLocalService.fetchLearningActivityResult(
			larId);
	}
	...
	@Override
	public com.ted.lms.model.LearningActivityResult
		fetchLearningActivityResultByUuidAndGroupId(String uuid, long groupId) {
	...
	public int getLearningActivityCountByActId(long actId) {
		return _learningActivityResultLocalService.
			getLearningActivityCountByActId(actId);
	}
	...
	public com.ted.lms.model.LearningActivityResult getLearningActivityResult(
		...
		return _learningActivityResultLocalService.getLearningActivityResult(
			larId);
	}
	...
	@Override
	public com.ted.lms.model.LearningActivityResult
			getLearningActivityResultByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public java.util.List<com.ted.lms.model.LearningActivityResult>
		getLearningActivityResults(int start, int end) {

		return _learningActivityResultLocalService.getLearningActivityResults(
			start, end);
	}
	...
	public java.util.List<com.ted.lms.model.LearningActivityResult>
		getLearningActivityResultsByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<com.ted.lms.model.LearningActivityResult> orderByComparator) {
	...
	public com.liferay.portal.kernel.model.PersistedModel getPersistedModel(
		...
		return _learningActivityResultLocalService.getPersistedModel(
			primaryKeyObj);
	}

	@Override
	public java.util.List<com.ted.lms.model.LearningActivityResult>
		getRequiredLearningActivityResults(long groupId, long userId) {

		return _learningActivityResultLocalService.
			getRequiredLearningActivityResults(groupId, userId);
	}

	@Override
	public int getRequiredLearningActivityResultsByModuleCount(
		long moduleId, long userId) {

		return _learningActivityResultLocalService.
			getRequiredLearningActivityResultsByModuleCount(moduleId, userId);
	}
	...
	public com.ted.lms.model.LearningActivityResult
		...
		return _learningActivityResultLocalService.updateLearningActivityResult(
			learningActivityResult);
	}
	...
	public com.ted.lms.model.LearningActivityResult
		...
		return _learningActivityResultLocalService.updateLearningActivityResult(
			learningActivityTry, serviceContext);
	}
	...
	private LearningActivityResultLocalService
		_learningActivityResultLocalService;
