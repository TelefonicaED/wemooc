...
public class CourseUtil {
	 ...
	 * @return the matching course, or <code>null</code> if a matching course could not be found
	 */
	public static Course fetchByGroupCreatedId(
		long groupCreatedId, boolean useFinderCache) {

		return getPersistence().fetchByGroupCreatedId(
			groupCreatedId, useFinderCache);
	}
	 ...
	 * @return the matching courses
	 */
	public static List<Course> findByparentCourseId(
	...
	public static List<Course> findByparentCourseId(
		...
		return getPersistence().findByparentCourseId(
			parentCourseId, status, start, end);
	}
	 ...
	 * @throws NoSuchCourseException if a matching course could not be found
	 */
	public static Course findByparentCourseId_First(
			long parentCourseId, int status,
			OrderByComparator<Course> orderByComparator)
		throws com.ted.lms.exception.NoSuchCourseException {

		return getPersistence().findByparentCourseId_First(
	 ...
	 * @return the first matching course, or <code>null</code> if a matching course could not be found
	 */
	public static Course fetchByparentCourseId_First(
		long parentCourseId, int status,
		OrderByComparator<Course> orderByComparator) {

		return getPersistence().fetchByparentCourseId_First(
			parentCourseId, status, orderByComparator);
	}
	 ...
	 * @throws NoSuchCourseException if a matching course could not be found
	 */
	public static Course findByparentCourseId_Last(
			long parentCourseId, int status,
			OrderByComparator<Course> orderByComparator)
		throws com.ted.lms.exception.NoSuchCourseException {

		return getPersistence().findByparentCourseId_Last(
			parentCourseId, status, orderByComparator);
	}
	 ...
	 * @return the last matching course, or <code>null</code> if a matching course could not be found
	 */
	public static Course fetchByparentCourseId_Last(
		long parentCourseId, int status,
		OrderByComparator<Course> orderByComparator) {

		return getPersistence().fetchByparentCourseId_Last(
			parentCourseId, status, orderByComparator);
	}
	 ...
	 * @throws NoSuchCourseException if a course with the primary key could not be found
	 */
	public static Course[] findByparentCourseId_PrevAndNext(
			long courseId, long parentCourseId, int status,
			OrderByComparator<Course> orderByComparator)
		throws com.ted.lms.exception.NoSuchCourseException {

		return getPersistence().findByparentCourseId_PrevAndNext(
			courseId, parentCourseId, status, orderByComparator);
	}
