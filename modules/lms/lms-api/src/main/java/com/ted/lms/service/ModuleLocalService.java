...
public interface ModuleLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ModuleLocalServiceUtil} to access the module local service. Add custom service methods to <code>com.ted.lms.service.impl.ModuleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Module copyModule(
			long userId, Module oldModule, long groupId,
	...
	public void updateAsset(
			long userId, Module module, long[] assetCategoryIds,
			String[] assetTagNames, long[] assetLinkEntryIds, Double priority)
		throws PortalException;

	public Module updateModule(
			long userId, long moduleId, Map<Locale, String> titleMap,
			Map<Locale, String> descriptionMap,
			boolean useStartExecutionDateCourse, int startDateMonth,
			int startDateDay, int startDateYear, int startDateHour,
			int startDateMinute, boolean useEndExecutionDateCourse,
	...
	public Module updateOrder(long userId, Module module, long priority)
		throws PortalException;
