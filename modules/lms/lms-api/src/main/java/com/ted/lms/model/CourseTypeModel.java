...
/**
 * The base model interface for the CourseType service. Represents a row in the &quot;LMS_CourseType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.ted.lms.model.impl.CourseTypeModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.ted.lms.model.impl.CourseTypeImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface CourseTypeModel
	extends BaseModel<CourseType>, GroupedModel, LocalizedModel, ShardedModel {
