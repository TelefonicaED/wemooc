 ...
 * <code>com.ted.lms.learning.activity.p2p.service.impl.P2PActivityCorrectionsLocalServiceImpl</code> and
...
public class P2PActivityCorrectionsLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ted.lms.learning.activity.p2p.service.impl.P2PActivityCorrectionsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static com.ted.lms.learning.activity.p2p.model.P2PActivityCorrections
		addP2PActivityCorrections(
			long actId, long userId, long p2pActivityId, long groupId,
			long companyId, long userCreatedId) {

		return getService().addP2PActivityCorrections(
	...
	public static boolean areAllCorrectionsDoneByUserInP2PActivity(
		long actId, long userId, int numValidations) {

		return getService().areAllCorrectionsDoneByUserInP2PActivity(
			actId, userId, numValidations);
	}

	public static void asignCorrectionsToP2PActivities(
		...
		getService().asignCorrectionsToP2PActivities(
	...
	public static com.ted.lms.learning.activity.p2p.model.P2PActivityCorrections
		...
		return getService().createP2PActivityCorrections(
	...
	public static com.ted.lms.learning.activity.p2p.model.P2PActivityCorrections
		...
		return getService().deleteP2PActivityCorrections(
			p2pActivityCorrectionsId);
	}
	...
	public static com.ted.lms.learning.activity.p2p.model.P2PActivityCorrections
		...
		return getService().fetchP2PActivityCorrections(
			p2pActivityCorrectionsId);
	}
	...
	public static com.ted.lms.learning.activity.p2p.model.P2PActivityCorrections
		...
		return getService().fetchP2PActivityCorrectionsByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static com.ted.lms.learning.activity.p2p.model.P2PActivityCorrections
		...
		return getService().getCorrectionsByP2PActivityIdUserId(
	...
	public static java.util.List
		...
		return getService().getP2PActivityCorrectionsByP2PActivityId(
			p2pActivityId);
	}
	...
	public static com.ted.lms.learning.activity.p2p.model.P2PActivityCorrections
		...
		return getService().getP2PActivityCorrectionsByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static java.util.List
		...
		return getService().getP2PActivityCorrectionsesByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static boolean hasAllCorrectionsDoneAboutUserInP2PActivity(
		...
		return getService().hasAllCorrectionsDoneAboutUserInP2PActivity(
	...
	public static com.ted.lms.learning.activity.p2p.model.P2PActivityCorrections
		...
		return getService().updateP2PActivityCorrections(
			p2pActivityCorrections);
	}
	...
	static {
		...
		ServiceTracker
			<P2PActivityCorrectionsLocalService,
			 P2PActivityCorrectionsLocalService> serviceTracker =
				new ServiceTracker
					<P2PActivityCorrectionsLocalService,
					 P2PActivityCorrectionsLocalService>(
