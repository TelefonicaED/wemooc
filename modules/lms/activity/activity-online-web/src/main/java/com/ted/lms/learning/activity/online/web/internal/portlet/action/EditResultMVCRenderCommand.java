...
@Component(
	...
	property = { "javax.portlet.name=" + OnlinePortletKeys.ONLINE,
			"mvc.command.name=/activity/online/edit_result" }, 
	service = MVCRenderCommand.class
)
public class EditResultMVCRenderCommand implements MVCRenderCommand {
	
	private static final Log log = LogFactoryUtil.getLog(EditResultMVCRenderCommand.class);
