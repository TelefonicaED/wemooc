...
public class TestActivityViewMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		if(!improve && result != null && result.isPassed() && !hasPermissionAccessCourseFinished) {
			...
			return renderResults(renderRequest, renderResponse, hasPermissionAccessCourseFinished, learningActivityTry, testActivityType, course, isLocked);
		}else {
				...
				if(Validator.isNotNull(navigateParam) || Validator.isNull(password) || passwordParam.equals(password)){
					...
					try {
						...
						if(activityTimestamp!=0 && timestamp<0){
							...
							return renderResults(renderRequest, renderResponse, hasPermissionAccessCourseFinished, learningTry, testActivityType, course, isLocked);
						}else {
							...
							correctURL.setParameter("actId", String.valueOf(actId));
							correctURL.setParameter("currentQuestionId", String.valueOf(currentQuestionId));
							...
							correctAccessFinishedURL.setParameter("actId", String.valueOf(actId));
							correctAccessFinishedURL.setParameter("currentQuestionId", String.valueOf(currentQuestionId));
	...
	public String renderResults(RenderRequest renderRequest, RenderResponse renderResponse, boolean hasPermissionAccessCourseFinished, 
			LearningActivityTry learningActivityTry, TestActivityType testActivityType, Course course, boolean isLocked) {
