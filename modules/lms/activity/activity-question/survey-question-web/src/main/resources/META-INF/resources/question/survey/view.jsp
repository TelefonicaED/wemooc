...
<%@page import="com.ted.lms.question.survey.SurveyQuestionType"%>
...
if(surveyQuestionType.getFormatType() == OptionsConstants.OPTION_FORMAT_TYPE_HORIZONTAL){
	cssclass="in-line ";
}else if(surveyQuestionType.getFormatType() == OptionsConstants.OPTION_FORMAT_TYPE_COMBO){
	isCombo = true;
}
