...
if (isCombo && !feedback){
	html += "<div class=\"question " + cssclass + "_select questiontype_" + surveyQuestionType.getType() + "\">" +
	...
	html += "<div class=\"question " + cssclass + " questiontype_" + surveyQuestionType.getType() + "\">" +
			"<input type=\"hidden\" name=\""+namespace+"question\" value=\"" + question.getQuestionId() + "\"/>"+
