...
AUI.add(
	...
	function(A) {
		...
		var AutoQuestions = A.Component.create(
			{
				...
				prototype: {
						...
						if (deleteRow) {
							...
							instance._undoManager.add(
								function(stateData) {
									...
									if (form) {
										form.fire('autoquestions:update');
									}
								}
							);
					...
					_attachSubmitListener: function() {
						...
						Liferay.on('submitForm', A.bind('fire', Liferay, 'saveAutoQuestions'));

						AutoQuestions.prototype._attachSubmitListener = Lang.emptyFn;
					},
		...
		Liferay.AutoQuestions = AutoQuestions;
	},
	'',
	{
		requires: ['aui-base', 'aui-data-set-deprecated', 'aui-io-request', 'aui-parse-content', 'base', 'liferay-form', 'liferay-input-localized', 'liferay-portlet-base', 'liferay-undo-manager', 'sortable']
	}
);
</aui:script>