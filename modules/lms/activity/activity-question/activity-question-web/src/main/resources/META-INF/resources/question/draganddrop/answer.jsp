...
<div class="col-md-10">
	...
	<aui:input name="<%=themeDisplay.getPortletDisplay().getNamespace() + iteratorQuestion + \"feedbackCorrect_\"+iterator %>" label="feedback" value='<%=answer != null ? answer.getFeedbackCorrect(): "" %>'
	 	useNamespace="false" type="text"/>
</div>
<div class="col-md-2">
