...
if(questionId > 0){
	...
	for(Answer answer:answers){
		...
		<div class="row" id='<%=themeDisplay.getPortletDisplay().getNamespace() + iteratorQuestion + "_answer_" + i%>'>
			<liferay-util:include page="<%=MultioptionsQuestionTypeFactory.URL_EDIT_ANSWER %>" portletId="<%=QuestionsWebPortletKeys.EDIT_QUESTIONS%>" servletContext="<%=this.getServletContext() %>">
