 ...
 * <code>com.ted.lms.learning.activity.question.service.impl.QuestionLocalServiceImpl</code> and
...
public class QuestionLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.ted.lms.learning.activity.question.service.impl.QuestionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static com.ted.lms.learning.activity.question.model.Question
		...
		return getService().addQuestion(
			userId, groupId, actId, questionText, questionType, penalize,
			serviceContext);
	}
	...
	public static com.ted.lms.learning.activity.question.model.Question
		...
		return getService().copyQuestion(
			userId, groupId, actId, oldQuestion, serviceContext);
	}
	...
	public static java.util.List
		<com.ted.lms.learning.activity.question.model.Question> getQuestions(
			int start, int end) {
	...
	public static com.ted.lms.learning.activity.question.model.Question
			updateQuestion(
				long userId, long questionId, String questionText,
				boolean penalize)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().updateQuestion(
			userId, questionId, questionText, penalize);
	}
