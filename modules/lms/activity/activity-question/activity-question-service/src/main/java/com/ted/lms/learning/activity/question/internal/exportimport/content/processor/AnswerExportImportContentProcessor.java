package com.ted.lms.learning.activity.question.internal.exportimport.content.processor;
...
@Component(
	property = "model.class.name=com.ted.lms.learning.activity.answer.model.Answer",
	service = {
		ExportImportContentProcessor.class,
		AnswerExportImportContentProcessor.class
	}
)
public class AnswerExportImportContentProcessor implements ExportImportContentProcessor<String> {
