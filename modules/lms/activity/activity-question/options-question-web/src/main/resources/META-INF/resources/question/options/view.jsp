...
if(optionsQuestionType.getFormatType() == OptionsConstants.OPTION_FORMAT_TYPE_HORIZONTAL){
	cssclass="in-line ";
}else if(optionsQuestionType.getFormatType() == OptionsConstants.OPTION_FORMAT_TYPE_COMBO){
	isCombo = true;
}
