...
System.out.println("namespace options q: " + namespace);
%>
...
<div class="col-md-10">
	...
	<aui:input name="<%=namespace + iteratorQuestion + \"_feedbackCorrect_\"+iterator %>" label="feedback" value='<%=answer != null ? answer.getFeedbackCorrect(): "" %>' useNamespace="false" />	
</div>
<div class="col-md-2">
