 ...
 */
@ProviderType
public class SurveyResultLocalServiceWrapper
	implements SurveyResultLocalService,
	...
	@Override
	public com.ted.lms.learning.activity.survey.model.SurveyResult
		addSurveyResult(
			long actId, long latId, long userId, long questionId, long answerId,
			String textAnswer) {

		return _surveyResultLocalService.addSurveyResult(
	...
	public long countAnswerByQuestionId(
		...
		return _surveyResultLocalService.countAnswerByQuestionId(
	...
	public long countAnswerByQuestionIdAnswerId(
		...
		return _surveyResultLocalService.countAnswerByQuestionIdAnswerId(
	...
	public long dynamicQueryCount(
		...
		return _surveyResultLocalService.dynamicQueryCount(
			dynamicQuery, projection);
	}

	@Override
	public java.io.File exportStatisticsAsFile(
			String applicationKey, long actId, java.util.Locale locale)
		throws Exception {

		return _surveyResultLocalService.exportStatisticsAsFile(
