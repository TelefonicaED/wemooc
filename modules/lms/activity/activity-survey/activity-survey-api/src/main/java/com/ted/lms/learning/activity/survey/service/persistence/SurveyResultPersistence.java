...
public interface SurveyResultPersistence extends BasePersistence<SurveyResult> {
	...
	*/
	public java.util.List<SurveyResult> findByUuid(String uuid, int start,
		int end);
	...
	*/
	public java.util.List<SurveyResult> findByUuid(String uuid, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<SurveyResult> orderByComparator);
	...
	* @return the range of matching survey results
	*/
	public java.util.List<SurveyResult> findByUserId(long userId, int start,
		int end);
	...
	* @return the range of matching survey results
	*/
	public java.util.List<SurveyResult> findByActId(long actId, int start,
		int end);
	...
	* @return the matching survey results
	*/
	public java.util.List<SurveyResult> findByQuestionIdActId(long questionId,
		long actId);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, SurveyResult> fetchByPrimaryKeys(
