 ...
 * {@link com.ted.lms.learning.activity.survey.service.impl.SurveyResultLocalServiceImpl} and is the
...
public class SurveyResultLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.ted.lms.learning.activity.survey.service.impl.SurveyResultLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static com.ted.lms.learning.activity.survey.model.SurveyResult addSurveyResult(
		long actId, long latId, long userId, long questionId, long answerId,
		String textAnswer) {
		return getService()
				   .addSurveyResult(actId, latId, userId, questionId, answerId,
			textAnswer);
	}
	...
	*/
	...
	public static long countAnswerByQuestionId(long questionId, long companyId,
		long courseGroupCreatedId) {
		return getService()
				   .countAnswerByQuestionId(questionId, companyId,
			courseGroupCreatedId);
	}

	public static long countAnswerByQuestionIdAnswerId(long questionId,
		long answerId, long companyId, long courseGroupCreatedId) {
		return getService()
				   .countAnswerByQuestionIdAnswerId(questionId, answerId,
	...
	*/
	public static com.ted.lms.learning.activity.survey.model.SurveyResult createSurveyResult(
		long surveyResultId) {
	...
	*/
	public static com.ted.lms.learning.activity.survey.model.SurveyResult deleteSurveyResult(
		long surveyResultId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static java.io.File exportStatisticsAsFile(String applicationKey,
		long actId, java.util.Locale locale) throws Exception {
		return getService().exportStatisticsAsFile(applicationKey, actId, locale);
	}

	public static com.ted.lms.learning.activity.survey.model.SurveyResult fetchSurveyResult(
		long surveyResultId) {
	...
	* @throws PortalException if a survey result with the primary key could not be found
	*/
	public static com.ted.lms.learning.activity.survey.model.SurveyResult getSurveyResult(
		long surveyResultId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.ted.lms.learning.activity.survey.model.SurveyResult> getSurveyResults(
		int start, int end) {
	...
	*/
	public static com.ted.lms.learning.activity.survey.model.SurveyResult updateSurveyResult(
		com.ted.lms.learning.activity.survey.model.SurveyResult surveyResult) {
	...
	private static ServiceTracker<SurveyResultLocalService, SurveyResultLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(SurveyResultLocalService.class);

		ServiceTracker<SurveyResultLocalService, SurveyResultLocalService> serviceTracker =
			new ServiceTracker<SurveyResultLocalService, SurveyResultLocalService>(bundle.getBundleContext(),
